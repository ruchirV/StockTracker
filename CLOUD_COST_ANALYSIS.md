...
3. The production architecture in `REQUIREMENTS.md` (ECS Fargate + RDS + ElastiCache) remains the documented *target* — it's what you describe in the portfolio README and architecture diagrams. You build toward it; you don't have to run it at full cost while developing.
