...
resource "aws_secretsmanager_secret_version" "database_url" {
  ...
  secret_string = "postgresql://${var.db_username}:${random_password.db_password.result}@${aws_db_instance.main.endpoint}/${var.db_name}?sslmode=require&uselibpqcompat=true"
